        ...
        <>
            ...
            <div>
                ...
                <div>
                    {" "}
                    {/* 상단 나브 바*/}
                    <img src="../media/rankpage_nav.png" alt="상단 나브 바" />
                    <div>
                        {" "}
                        {/* 사용자 정보 */}
                ...
                <div>
                            ...
                            <div>
                                ...
                                <PowerBIEmbed
                                    embedConfig={{
                                        ...
                                        embedUrl:
                                            "https://app.powerbi.com/reportEmbed?reportId=30a825e3-341b-40a9-9466-ae3763719b5e&config=eyJjbHVzdGVyVXJsIjoiaHR0cHM6Ly9XQUJJLVVTLUNFTlRSQUwtQS1QUklNQVJZLXJlZGlyZWN0LmFuYWx5c2lzLndpbmRvd3MubmV0IiwiZW1iZWRGZWF0dXJlcyI6eyJtb2Rlcm5FbWJlZCI6dHJ1ZSwidXNhZ2VNZXRyaWNzVk5leHQiOnRydWV9fQ%3d%3d", //'<Embed Url>',
                                        accessToken:
                    ...
                    <div>
                        ...
                        <div>
                            {" "}
                            {/* 목차 */}
                            <img src="../media/Patient.png" alt="환자 이미지" />
                            <p>환자</p>
                        </div>
                        <div>
                            {" "}
                    ...
                    <div>
                        ...
                        <div>
                            {" "}
                            {/* 목차 */}
                            <img src="../media/Other.png" alt="기타 이미지" />
                            <p>기타</p>
                        </div>
                        <div>
                            {" "}
