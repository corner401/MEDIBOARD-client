        ...
        <>
            <div className={styles.container}>
                ...
                <Link className={styles.menu} to={"/"}>
                    <img
                        className={styles.icon}
                        src={require("../media/home_icon.png")}
                        alt={`home`}
                    />
                ...
                <Link className={styles.menu} to={"/dashboard"}>
                    <img
                        className={styles.icon}
                        src={require("../media/dashboard_icon.png")}
                        alt={`dashboard`}
                    />
                ...
                <Link className={styles.menu} to={"/chart"}>
                    <img
                        className={styles.icon}
                        src={require("../media/chart_icon.png")}
                        alt={`chart`}
                    />
                    <div className={styles.menutext}>
                        통계 자료<br></br> 열람
                ...
                <Link className={styles.menu} to={"/news"}>
                    <img
                        className={styles.icon}
                        src={require("../media/news_icon.png")}
                        alt={`news`}
                    />
                ...
                <Link className={styles.menu} to={"/rank"}>
                    <img
                        className={styles.icon}
                        src={require("../media/rank_icon.png")}
                        alt={`rank`}
                    />
